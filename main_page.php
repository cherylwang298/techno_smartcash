...
<?php endif; ?>
        ...
        <div class="flex-1 overflow-y-auto pb-32 hide-scrollbar bg-slate-50/50">
            ...
            <div class="mt-5 px-5 grid grid-cols-3 gap-3">
                <div class="premium-card p-4 rounded-2xl text-center border-b-4 border-cyan-azure">
                    ...
                    <p class="text-[12px] font-black text-space-cadet mt-1">1.5M</p>
                </div>
                <div class="premium-card p-4 rounded-2xl text-center border-b-4 border-pink-lavender">
                    ...
                    <p class="text-[12px] font-black text-space-cadet mt-1">450K</p>
                </div>
                <div class="premium-card p-4 rounded-2xl text-center border-b-4 border-ucla-blue bg-slate-50">
                    ...
                    <p class="text-[12px] font-black text-space-cadet mt-1">1.05M</p>
                </div>
            </div>

            <div class="px-5 mt-5 grid grid-cols-2 gap-4">
                <button
                    class="p-5 rounded-[30px] flex flex-col items-center bg-cyan-azure/70 border-2 border-white/20 active:scale-95 transition-all group shadow-lg">
                    <div
                        class="w-12 h-12 rounded-2xl bg-white/20 text-white flex items-center justify-center mb-3 transition-all group-hover:bg-white group-hover:text-cyan-azure">
                ...
                <button
                    class="p-5 rounded-[30px] flex flex-col items-center bg-pink-lavender/70 border-2 border-white/20 active:scale-95 transition-all group shadow-lg">
                    <div
                        class="w-12 h-12 rounded-2xl bg-white/20 text-white flex items-center justify-center mb-3 transition-all group-hover:bg-white group-hover:text-pink-lavender">
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="bg-white hover:bg-slate-50 transition">
                                <td class="px-6 py-5 text-xs font-black text-ucla-blue italic">Kopi Gula Aren</td>
                                <td class="px-6 py-5 text-xs font-black text-space-cadet text-right">45 pcs</td>
                            </tr>
                            <tr class="bg-slate-50/50 hover:bg-slate-50 transition">
                                <td class="px-6 py-5 text-xs font-black text-ucla-blue italic">Roti Bakar Cokelat</td>
                                <td class="px-6 py-5 text-xs font-black text-space-cadet text-right">32 pcs</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div
            ...
            <a href="kasir.html" class="flex flex-col items-center text-ucla-blue/30 hover:text-space-cadet transition">
            ...
            <a href="stok.html" class="flex flex-col items-center text-ucla-blue/30 hover:text-space-cadet transition">
